				...
				<div class="col-lg-12">
					...
					foreach($pricelists as $countryCode => $pricelist) {
						...
						<li data-language="' . $countryCode . '" class="' . $selected . '">
							<p><img class="country-flag" src="img/flags/' . $countries[$countryCode]['lang'] . '.png" alt=""><span>' . $countries[$countryCode]['country_' . $languageSelected] . '</span></p>
						';
						$counter++;
					} 
					echo $pricelistHtml;
