	...
	<div class="container">
		<div class="row shop-content">
				...
				<div class="col-lg-6 col-xs-6 shop-content-details">
					...
					<div class="col-lg-12 col-xs-12">
						...
						<div class="col-lg-9 col-xs-9">
							<!-- <p><?= $texts['Magazin3.address1']; ?> - <a href="#">Open in Maps</a></p> -->
							<p><?= $texts['Magazin3.address1']; ?> - <?= $texts['Magazin3.address2']; ?></p>
						</div>
						<div class="col-lg-3 col-xs-3">
							<p>Telephone:</p>
						</div>
						<div class="col-lg-9 col-xs-9">
							<p><?= $texts['Magazin3.telephone']; ?></p>
						</div>
						<div class="col-lg-3 col-xs-3">
							<p>email:</p>
						</div>
						<div class="col-lg-9 col-xs-9">
							<p><?= $texts['Magazin3.email']; ?></p>
						</div>
						<div class="col-lg-3 col-xs-3">
							<p>Variety:</p>
						</div>
			...
			<div class="col-lg-12 shop-content-promotions">
				...
				<div id="odense-products" class="row list-group">
					<?php
						echo showPromotions($promotions['shop_3'], 'shop_3');
					?>
				</div>
			</div>
			<div class="col-lg-12 col-xs-12 variety-flags">
				<p class="description">
					<?= $texts['Magazin3.description']; ?>
				</p>
				<div id="odense-map" class="map"></div>
			</div>
		</div>
	</div>
</section>