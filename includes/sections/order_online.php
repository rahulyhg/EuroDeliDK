...
$(document).ready(function() {
	...
	$('#sendOrderForm').click(function(event) {
		...
		$('#sendOrderForm').prop('disabled', true);
		...
		$.ajax({
			...
			success: function(response) {
				...
				$('#sendOrderForm').prop('disabled', false);
		...
		<div class="container container-order">
			...
			<div class="row">
				...
				<div class="col-lg-5">
					...
					<p>
						<img class="order-icon"  src="img/shop/email.png" style="margin-bottom:20px" alt="<?= $texts['Contact.note']; ?>" />
