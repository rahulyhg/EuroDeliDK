<?php
// get all promotions
$stmt = $db->prepare('SELECT * FROM promotions WHERE `type`="new"');
$stmt->execute();
				...
				<div class="panel panel-default">
					<div class="row">
						<span class="col-xs-3 col-md-3 col-lg-3">
							...
							<div class="input-group">
								<input type="text" class="form-control" value="' . $text['new_price'] . '" data-name="new_price" name="new_price"  placeholder="Price">
							</div>
						</span>
					</div>
				</div>
...
<ul class="list-group">
	<li class="list-group-item table-headers">
		<div class="row">
			<span class="col-xs-10 col-md-10 col-lg-10"><h4>Product:</h4></span>
					...
					<div class="panel panel-default">
						<div class="row">
							<span class="col-xs-3 col-md-3 col-lg-3">
								<label for="new_price">Price</label>
								<div class="input-group">
									<input type="text" class="form-control" data-name="new_price" name="new_price"  placeholder="Price">
									<input type="hidden"  value="new" data-name="type" name="type">
